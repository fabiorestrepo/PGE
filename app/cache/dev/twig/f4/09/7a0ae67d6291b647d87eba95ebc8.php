...
class __TwigTemplate_f4097a0ae67d6291b647d87eba95ebc8 extends Twig_Template
{
    ...
    ");
        ...
        if ($this->getAttribute((($this->getAttribute(((array_key_exists("collector", $context)) ? (twig_default_filter($this->getContext($context, "collector"))) : ("")), "controller", array(), "any", true)) ? (twig_default_filter($this->getAttribute($this->getContext($context, "collector"), "controller", array(), "any", false))) : ("")), "class", array(), "any", true)) {
            ...
            if ($this->getContext($context, "link")) {
                ...
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "controller", array(), "any", false), "method", array(), "any", false), "html", null, true);
                echo "</a>";
            } else {
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "collector"), "controller", array(), "any", false), "method", array(), "any", false), "html", null, true);
            }
            ...
            // line 15
            echo "                <span>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "controller", array(), "any", false), "html", null, true);
            echo "</span>
            ";
        }
        // line 17
        ...
        echo ">";
        echo twig_escape_filter($this->env, (($this->getAttribute($this->getContext($context, "collector"), "route", array(), "any", false)) ? ($this->getAttribute($this->getContext($context, "collector"), "route", array(), "any", false)) : ("NONE")), "html", null, true);
        echo "</span>
        ...
        echo "\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "statuscode", array(), "any", false), "html", null, true);
        echo "</span>
        ";
...
";
    ...
    <p>
        ...
        ";
            ...
            // line 84
            echo "            <pre>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "content", array(), "any", false), "html", null, true);
            echo "</pre>
        ";
        } else {
            // line 86
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "sessionattributes", array(), "any", false))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
                ...
                echo "</th>
                    <td>";
                // line 110
                echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->dump($this->getAttribute($this->getContext($context, "attributes"), $this->getContext($context, "key"), array(), "array", false)), "html", null, true);
                echo "</td>
                </tr>
            ";
            }
    ...
    ";
        ...
        if ($this->getAttribute($this->getContext($context, "profile"), "parent", array(), "any", false)) {
            // line 122
            echo "        <h2><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_profiler", array("token" => $this->getAttribute($this->getAttribute($this->getContext($context, "profile"), "parent", array(), "any", false), "token", array(), "any", false))), "html", null, true);
            echo "\">Parent request: ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "profile"), "parent", array(), "any", false), "token", array(), "any", false), "html", null, true);
            echo "</a></h2>
    ...
    ";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
                // line 131
                echo "            <h3><a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_profiler", array("token" => $this->getAttribute($this->getContext($context, "child"), "token", array(), "any", false))), "html", null, true);
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "child"), "token", array(), "any", false), "html", null, true);
                echo "</a></h3>
            ";
                // line 132
