...
class __TwigTemplate_0d3e8cbb0788669fd920b10ac77979b9 extends Twig_Template
{
    ...
    ");
        ...
        // line 8
        echo "        ";
        echo twig_escape_filter($this->env, sprintf("%.0f", ($this->getAttribute($this->getContext($context, "collector"), "memory", array(), "any", false) / 1024)), "html", null, true);
        echo " KB
    ";
