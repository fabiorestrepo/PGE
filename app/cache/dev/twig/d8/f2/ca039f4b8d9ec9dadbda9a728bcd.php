...
class __TwigTemplate_d8f2ca039f4b8d9ec9dadbda9a728bcd extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 3
        $context["__internal_d8f2ca039f4b8d9ec9dadbda9a728bcd_1"] = $this;
...
";
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
            ...
            echo "            <tr>
                <td><code>";
            // line 22
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listener"), "event", array(), "any", false), "html", null, true);
            echo "</code></td>
                <td><code>";
            // line 23
            echo twig_escape_filter($this->env, $this->getAttribute($context["__internal_d8f2ca039f4b8d9ec9dadbda9a728bcd_1"], "display_listener", array($this->getContext($context, "listener"), ), "method", false), "html", null, true);
            echo "</code></td>
            </tr>
        ";
        }
        ...
        <table>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                ...
                echo "                <tr>
                    <td><code>";
                // line 39
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "listeners"), $this->getContext($context, "listener"), array(), "array", false), "event", array(), "any", false), "html", null, true);
                echo "</code></td>
                    <td><code>";
                // line 40
                echo twig_escape_filter($this->env, $this->getAttribute($context["__internal_d8f2ca039f4b8d9ec9dadbda9a728bcd_1"], "display_listener", array($this->getAttribute($this->getContext($context, "listeners"), $this->getContext($context, "listener"), array(), "array", false), ), "method", false), "html", null, true);
                echo "</code></td>
                </tr>
            ";
            }
    ...
    ";
                ...
                if ($this->getContext($context, "link")) {
                    ...
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listener"), "function", array(), "any", false), "html", null, true);
                    echo "</a>";
                } else {
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listener"), "function", array(), "any", false), "html", null, true);
                }
                ...
                if ($this->getContext($context, "link")) {
                    ...
                    echo twig_escape_filter($this->env, $this->getContext($context, "link"), "html", null, true);
                    echo "\">";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listener"), "method", array(), "any", false), "html", null, true);
                    echo "</a>";
                } else {
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "listener"), "method", array(), "any", false), "html", null, true);
                }
