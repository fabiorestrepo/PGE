...
class __TwigTemplate_44f881bc41d16d4f1fbf12144fd940fd extends Twig_Template
{
    ...
    ");
        ...
        // line 8
        echo "        <span title=\"";
        echo twig_escape_filter($this->env, sprintf("%0.2f", ($this->getAttribute($this->getContext($context, "collector"), "time", array(), "any", false) * 1000)), "html", null, true);
        echo " ms\">";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "querycount", array(), "any", false), "html", null, true);
        echo "</span>
    ";
    ...
    <span class=\"count\">
        ...
        <span>";
        // line 19
        echo twig_escape_filter($this->env, sprintf("%0.0f", ($this->getAttribute($this->getContext($context, "collector"), "time", array(), "any", false) * 1000)), "html", null, true);
        echo " ms</span>
    </span>
</span>
";
            ...
            foreach ($context['_seq'] as $context["i"] => $context["query"]) {
                ...
                echo "\">
                    <div>
                        <code>";
                // line 36
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "query"), "sql", array(), "any", false), "html", null, true);
                echo "</code>
                    </div>
                    <small>
                        <strong>Parameters</strong>: ";
                // line 39
                echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->encode($this->getAttribute($this->getContext($context, "query"), "params", array(), "any", false)), "html", null, true);
                echo "<br />
                        <strong>Time</strong>: ";
                // line 40
                echo twig_escape_filter($this->env, sprintf("%0.2f", ($this->getAttribute($this->getContext($context, "query"), "executionMS", array(), "any", false) * 1000)), "html", null, true);
                echo " ms
                    </small>
                </li>
            ";
