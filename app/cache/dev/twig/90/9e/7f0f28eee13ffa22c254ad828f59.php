...
class __TwigTemplate_909e7f0f28eee13ffa22c254ad828f59 extends Twig_Template
{
    ...
    ";
        ...
        if ($this->getContext($context, "verbose")) {
            ...
            // line 12
            echo "                <span>PHP ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "phpversion", array(), "any", false), "html", null, true);
            echo "</span>
    ...
    ");
        ...
        if ($this->getContext($context, "verbose")) {
            // line 29
            echo "                <span>";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "appname", array(), "any", false), "html", null, true);
            echo "</span>
                <span style=\"margin: 0; padding: 0; color: #979696;\">|</span>
                <span>";
            // line 31
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "env", array(), "any", false), "html", null, true);
            echo "</span>
                <span style=\"margin: 0; padding: 0; color: #979696;\">|</span>
                <span>";
            // line 33
        ...
        if ($this->getContext($context, "profiler_url")) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "token", array(), "any", false), "html", null, true);
            echo "</a>
                ";
        } else {
            // line 40
...
";
    ...
    <table>
        ...
        <tr>
            ...
            <td>";
        // line 64
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "collector"), "symfonyversion", array(), "any", false), "html", null, true);
        echo "</td>
        </tr>
        <tr>
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["name"]) {
            ...
            <td>";
            // line 122
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "bundles"), $this->getContext($context, "name"), array(), "array", false), "html", null, true);
            echo "</td>
        </tr>
        ";
        }
