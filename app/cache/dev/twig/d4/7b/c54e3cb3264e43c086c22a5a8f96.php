...
class __TwigTemplate_d47bc54e3cb3264e43c086c22a5a8f96 extends Twig_Template
{
    ...
    <div id=\"content\">
        ...
        if ($this->getContext($context, "profile")) {
            ...
            echo "            <div id=\"resume\">
                <p>
                    <strong><a href=\"";
            // line 13
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "url", array(), "any", false), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "url", array(), "any", false), "html", null, true);
            echo "</a></strong>
                    <span class=\"date\">
                        <strong>by ";
            // line 15
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "profile"), "ip", array(), "any", false), "html", null, true);
            echo "</strong> at <strong>";
            echo twig_escape_filter($this->env, twig_date_format_filter($this->getAttribute($this->getContext($context, "profile"), "time", array(), "any", false), "r"), "html", null, true);
            echo "</strong>
                    </span>
                </p>
            </div>
        ...
        if (array_key_exists("templates", $context)) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                echo "                                ";
                ob_start();
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "template"), "renderBlock", array("menu", array("collector" => $this->getAttribute($this->getContext($context, "profile"), "getcollector", array($this->getContext($context, "name"), ), "method", false)), ), "method", false), "html", null, true);
