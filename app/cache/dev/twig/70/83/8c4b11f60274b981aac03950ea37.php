...
class __TwigTemplate_70838c4b11f60274b981aac03950ea37 extends Twig_Template
{
    ...
    ");
        ...
        // line 8
        echo "        ";
        echo twig_escape_filter($this->env, sprintf("%.0f", ($this->getAttribute($this->getContext($context, "collector"), "time", array(), "any", false) * 1000)), "html", null, true);
        echo " ms
    ";
