...
class __TwigTemplate_e726753790c7bbb5404bcfc6804e4b6b extends Twig_Template
{
    ...
    <body>
        ...
        if ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session", array(), "any", false), "flash", array("notice", ), "method", false)) {
            ...
            echo "                <div class=\"flash-message\">
                    <em>Notice</em>: ";
            // line 24
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, "app"), "session", array(), "any", false), "flash", array("notice", ), "method", false), "html", null, true);
            echo "
                </div>
            ";
        }
