...
class __TwigTemplate_7257626732f71511f92d747b9fa771e0 extends Twig_Template
{
...
<div class=\"sf-toolbarreset\"
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["name"] => $context["template"]) {
            // line 34
            echo "        ";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "template"), "renderblock", array("toolbar", array("collector" => $this->getAttribute($this->getContext($context, "profile"), "getcollector", array($this->getContext($context, "name"), ), "method", false), "profiler_url" => $this->getContext($context, "profiler_url"), "token" => $this->getAttribute($this->getContext($context, "profile"), "token", array(), "any", false), "name" => $this->getContext($context, "name"), "verbose" => $this->getContext($context, "verbose")), ), "method", false), "html", null, true);
            // line 41
            echo "
    ";
        }
