...
class __TwigTemplate_b3de746c79a9bddff1c6b2e3c736b131 extends Twig_Template
{
    ...
    public function block_widget_choice_options($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["choice"] => $context["label"]) {
            ...
            if ($this->env->getExtension('form')->isChoiceGroup($this->getContext($context, "label"))) {
                // line 31
                echo "            <optgroup label=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getContext($context, "choice"), array(), $this->getContext($context, "translation_domain")), "html", null, true);
                echo "\">
                ";
                // line 32
                $context['_parent'] = (array) $context;
                ...
                foreach ($context['_seq'] as $context["nestedChoice"] => $context["nestedLabel"]) {
                    ...
                    echo ">";
                    echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getContext($context, "nestedLabel"), array(), $this->getContext($context, "translation_domain")), "html", null, true);
                    echo "</option>
                ";
                }
    ...
    public function block_field_errors($context, array $blocks = array())
    {
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["error"]) {
                // line 253
                echo "            <li>";
                echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans($this->getAttribute($this->getContext($context, "error"), "messageTemplate", array(), "any", false), $this->getAttribute($this->getContext($context, "error"), "messageParameters", array(), "any", false), "validators"), "html", null, true);
                echo "</li>
        ";
            }
            $_parent = $context['_parent'];
